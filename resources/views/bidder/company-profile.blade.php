...
<div class="admin-dashboard dashboard-home bidder-company-page">
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ route('bidder.company-profile') }}" class="active"><i class="fas fa-building"></i> Company Profile</a></li>
    ...
    <div class="main-area">
        ...
        <main class="dashboard-content dashboard-home-content">
            <section class="page-intro">
                ...
                <p class="page-subtitle">Your registered company information</p>
            </section>
